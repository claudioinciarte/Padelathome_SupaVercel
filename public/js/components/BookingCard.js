            ...
            const cardHTML = `
                <div class="bg-white border border-slate-200 rounded-xl p-4 md:p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4 w-full">
                    ...
                    <div class="flex flex-col md:flex-row gap-2 w-full md:w-auto mt-3 md:mt-0">
                        <button class="action-btn w-full md:w-auto inline-flex justify-center items-center rounded-lg border border-primary bg-primary px-4 py-2 text-sm font-bold text-on-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors" data-action="details" data-id="${booking.id}">
